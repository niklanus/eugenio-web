...
if($_POST)
{
    $to_email = "eugeniochouhy@gmail.com"; //Recipient email, Replace with own email here
    ...
    $send_mail = mail($to_email, "Dr. Eugenio Chouhy - Formulario de contacto", $msg_body, $headers);
